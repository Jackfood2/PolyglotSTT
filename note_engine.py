...
# ── Note file-import helpers ──────────────────────────────────────────
# v1.4.0: moved to services/note_format.py. Re-exported here so
# `from note_engine import format_note_sentences` keeps working.
try:
...
except Exception:  # pragma: no cover - fallback if services/ missing
